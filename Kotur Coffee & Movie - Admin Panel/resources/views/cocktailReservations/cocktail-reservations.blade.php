                    ...
                    <table class="min-w-full table-auto divide-y divide-gray-200">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Тип на Настан</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Порака</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Датум</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Час</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase">Креирано</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 text-sm space-x-2">
                                    <a href="{{ route('cocktail.reservations.edit', $reservation->id) }}"
                                        class="text-blue-600 hover:text-blue-800 font-medium">Промени</a>

                                    <form action="{{ route('cocktail.reservations.delete', $reservation->id) }}"

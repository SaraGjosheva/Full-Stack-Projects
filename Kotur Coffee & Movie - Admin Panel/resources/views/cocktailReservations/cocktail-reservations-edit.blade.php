<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Промени Резервација за Коктел') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('cocktail.reservations.update', $reservation->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="full_name" name="full_name" type="text"
                            ...
                            :value="old('full_name', $reservation->full_name)" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="event_type" name="event_type" type="text"
                            class="block mt-1 w-full"
                            :value="old('event_type', $reservation->event_type)" required />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="message" name="message"
                            ...
                            rows="4" required>{{ old('message', $reservation->message) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="reservation_hour" name="reservation_hour" type="time"
                            class="block mt-1 w-full"
                            :value="old('reservation_hour', $reservation->reservation_hour)" required />

                ...
                <form action="{{ route('players.update', $player) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name"
                            ...
                            class="mt-1 block w-full border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-900 text-white placeholder-gray-400 py-2 px-3 shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <select id="team_id" name="team_id"
                            ...
                            <option value="{{ $id }}" {{ old('team_id', $player->team_id) == $id ? 'selected' : '' }}>
                                {{ $name }}
                            </option>
                            @endforeach
                        </select>
